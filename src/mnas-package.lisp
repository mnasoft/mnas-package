...
(defpackage :mnas-package
  ...
  (:documentation
   "@b(Описание:) пакет @b(mnas-package) является основным в системе
 @b(mnas-package).
...
(defun rsync-doc (system-name)
  ...
  выбирается в зависимости от имени хоста, с которого выполняется
  копирование, и содержимого глобальной переменной *intranet-hosts*.
